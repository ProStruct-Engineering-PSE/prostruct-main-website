...
// State header menu - same structure as Header.tsx
// Will be customized based on state
const HEADER_MENU = [
  {
    id: 1144,
    title: "Residential",
    ...
    children: [
      ...
      { id: 1145, title: "New Custom Home", url: "/services/for-new-custom-home" },
      {
        id: 1146,
      ...
      { id: 1148, title: "Retaining Wall", url: "/services/for-retaining-wall" },
      {
        id: 1149,
...
// State header component (header-with-state.php)
// Used for state-specific pages (Oregon, Washington, Arizona, Texas, Georgia, New Mexico, Idaho, Utah, Nevada, Colorado)
export function HeaderWithState() {
  ...
  // Determine logo link (from header-with-state.php logic)
  const getLogoLink = () => {
    if (
    ...
    if (
      ...
      pathname.includes("/arizona-customer-reviews")
    )
  ...
  const stateBase = getLogoLink();
  const normalizeBase =
    stateBase === "/" ? "" : stateBase.replace(/\/$/, "");
    ...
    <header className="o-header w-100">
      <div className="container">
        <div className="d-flex align-items-center">
          <Link href={stateBase} className="o-logo">
            <Image
              src={LOGO_URL}
      ...
      {/* Mobile Offcanvas Menu (React state) */}
      {isMobileMenuOpen && (
        <>
          <div
